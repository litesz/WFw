namespace WFw.Redis
{
    ...
    public partial class WFwRedisCache : IRedisCache
    {
        ...
        public long LPush<T>(string key, params T[] values) => RedisHelper.LPush<T>(key, values);
        ...
        public long LPushX<T>(string key, T value) => RedisHelper.LPushX(key, value);
        ...
        public long RPush<T>(string key, params T[] values) => RedisHelper.RPush<T>(key, values);
        ...
        public long RPushX<T>(string key, T value) => RedisHelper.RPushX(key, value);
    }
}
