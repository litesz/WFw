...
namespace WFw.Redis
{
    ...
    public partial class WFwRedisCache : IRedisCache
    {
        ...
        public bool PfAdd<T>(string key, params T[] elements) => RedisHelper.PfAdd(key, elements);
        ...
        public long PfCount(params string[] keys) => RedisHelper.PfCount(keys);
        ...
        public bool PfMerge(string destKey, params string[] sourceKeys) => RedisHelper.PfMerge(destKey, sourceKeys);
    }
}
