...
namespace WFw.Redis
{
    ...
    partial interface IRedisCache : ICache
    {
        ...
        /// <returns>指定区间内的元素列表</returns>
        T[] ZRangeByLex<T>(string key, string min, string max, long? limit = null, long offset = 0L);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns>指定区间内的元素列表</returns>
        T[] ZRangeByScore<T>(string key, decimal min, decimal max, long? limit = null, long offset = 0L);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns>指定区间内，带有分数值(可选)的有序集成员的列表。 </returns>
        T[] ZRevRangeByScore<T>(string key, string max, string min, long? limit = null, long offset = 0L);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns>指定区间内，带有分数值(可选)的有序集成员的列表。 </returns>
        T[] ZRevRangeByScore<T>(string key, decimal max, decimal min, long? limit = null, long offset = 0L);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns>指定区间内，带有分数值(可选)的有序集成员的列表。 </returns>
        (T member, decimal score)[] ZRevRangeByScoreWithScores<T>(string key, string max, string min, long? limit = null, long offset = 0L);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns>指定区间内，带有分数值(可选)的有序集成员的列表。 </returns>
        (T member, decimal score)[] ZRevRangeByScoreWithScores<T>(string key, decimal max, decimal min, long? limit = null, long offset = 0L);
        ...
        ScanResult<(T member, decimal score)> ZScan<T>(string key, long cursor, string pattern = null, long? count = null);
    }
}
